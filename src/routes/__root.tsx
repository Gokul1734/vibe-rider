...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ridedeck — Premium Motorcycle TFT Dashboard" },
      ...
      { property: "og:title", content: "Ridedeck — Premium Motorcycle TFT Dashboard" },
      { property: "og:description", content: "Turn your phone into a premium motorcycle TFT dashboard." },
