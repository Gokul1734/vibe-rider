...
export function SpotifyPlayer() {
  ...
  return (
    <div className="glass-strong rounded-2xl px-3 py-2 flex items-center gap-3">
      {/* Album art */}
      <div className="relative shrink-0">
        ...
        >
          <div className="absolute inset-1 rounded-lg bg-black grid place-items-center">
      ...
      <div className="flex-1 min-w-0 flex items-center gap-3">
        <div className="min-w-0 flex-1">
          <div className="flex items-baseline justify-between gap-2">
            <div className="min-w-0">
              <div className="font-display text-xs text-white truncate">Midnight Rider</div>
              <div className="text-[10px] text-white/55 truncate">The Highway Collective</div>
            </div>
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="hidden sm:flex items-center gap-1.5 text-white/60 ml-1">
