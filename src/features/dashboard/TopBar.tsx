...
export function TopBar() {
  ...
  return (
    <div className="flex items-center justify-between gap-16 px-4 py-2 glass rounded-2xl shrink-0 max-w-100">
      <div className="flex flex-col gap-0.5 min-w-0">
        ...
        <div className="text-lg sm:text-xl lg:text-xl tracking-wide uppercase panel-label font-display font-semibold text-nowrap">
          {dateLabel}
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4 text-foreground shrink-0">
        <button
          onClick={cycleMode}
          className="flex items-center gap-2 px-5 py-6 rounded-lg hover:bg-foreground/5 border border-[var(--panel-border)]"
